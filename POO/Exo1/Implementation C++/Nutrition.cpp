...
int main(){
  Plat listPlat[50];
		...
		cout << "Rubrique 2 : Aliment proteine";
		cout << "Votre plat contient-il des aliments proteine ? [0=Non, 1=Oui] :";
		cin >> infoAlProt1;
		if(infoAlProt1>0)
		{
			cout << "De quel type est cet aliment proteine avez vous envie ? [1=Viande, 2=Poisson, 3=Crustace] :";
			cin >> infoAlProt2 ;
			switch(infoAlProt2)
			{
				case 1: 
		...
		cout << "Rubrique 3 : Complement";
		cout << "Votre plat contient-il des complements ? [0=Non, 1=Oui] :";
		cin >> infoCompl1;
		if(infoCompl1>0)
		{
			cout << "De quel complement avez vous envie ? [1=Riz, 2=Pomme, 3=****] :";
			cin >> infoCompl2;
			switch(infoCompl2)
			{
				case 1: 
		...
		cout << "Rubrique 4 : Epices";
		cout << "Votre plat a t-il des epices visibles ? [0=Non, 1=Oui] :";
		cin >> infoEpice ;
		int i,j,k;
		int nbTrouve=0;
		for(i=0;i<nbPlat;i++)
