...
class Repas{
	constructor (sexeval,ageval,date,heureval,repasval,uniteval,lieuval,nbpersval)
	{
		this.sexe=sexeval;
		this.age=ageval;
		this.date=date;
...
class LinkedList{
	...
	print_list()
	{
		...
		while(tmp)
		{
			console.log(tmp.data.repas+"\t"+tmp.data.age);
			tmp=tmp.next;
		}
	}
...
pile=pile.sort_list();
pile.print_list();
console.log("Le minimum est : "+pile.minimum().repas);
console.log("Resultat de la recherche : "+pile.search_elt("Koki"));
